...
The **Bites & Banter** site (`index.html`) includes a live Random Order Generator section. Open the page in a browser, scroll to "Can't Decide?", enter a name, and click **Generate My Order**. Use the **Copy Order** button to copy the result to the clipboard.
